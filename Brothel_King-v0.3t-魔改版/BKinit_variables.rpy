...
#                        "group result bad" : "{color=[c_lightred]}%s cried and screamed as the %ss took turns violating her body.{/color} Gizel kept tauting her during the whole ordeal as she sobbed silently.",
    ...
    girl_name_dict = {"syllabs" : ["赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "朱", "孔", "曹", "孟", "何", "吕", "施", "张", "蒋", "沈", "韩", "杨", "姜", 
                                   "唐", "柳", "星", "郝", "纪", "方", "文", "温", "秋", "邱", "祝", "竹", "彩", "帝", "林", "灵", "凌", "风", "凤", "商", "严", "魏", "谢", 
                                   "水", "云", "苏", "素", "花", "苗", "安", "罗", "俞", "任", "袁", "倪", "乐", "于", "时", "傅", "顾", "米", "明", "杜", "江", "梅", "虞", 
                                   "高", "夏", "柯", "夕", "希", "宁", "束", "叶", "司", 
                                   "上官", "欧阳", "西门", "司马", "东方", "南宫", "慕容", "端木", "公孙", "令狐", "宇文", "夏侯", "诸葛", "尉迟", "皇甫", "詹台", "公冶"],
                                   
                      "fillers" : ["铃", "雪", "诗", "妍", "琳", "婉", "馨", "悠", "恬", "甜", "柔", "小", "瑶", "香", "书", "美", "飘", "墨", "蓝", "襄", "晨", "梦", "若", 
                                   "芷", "茹", "一", "依", "瑄", "天", "景", "妃", "蕾", "巧", "尤", "月", "花", "华", "冬", "芊", "紫", "梓", "桃", "幂", "珍", "贞", "仙", 
                                   "蒂", "雯", "玉", "梅", "兰", "竹", "菊", "竺", "茱", "莫", "言", "汐", "皇", "飞", "非", "菲", "津", "金", "锦", "谨", "堇", "矜", "静", 
                                   "婧", "净", "璟", "沫", "卿", "倾", "情", "菀", "婠", "冥", "溟", "茗", "澪", "龄", "泷", "书"],
                      
                      "enders" : ["儿", "语", "羽", "盈", "蕊", "彤", "茜", "娜", "菲", "琪", "涵", "曦", "兮", "然", "纯", "冰", "一", "乔", "悠", "诗", "师", "莉", "丽", 
                                  "依", "瑄", "天", "景", "妃", "梅", "兰", "竹", "菊"],
