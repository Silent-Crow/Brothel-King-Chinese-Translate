...
screen item_profile(it):
    ...
    frame:
        ...
        if "bargain" not in acts:
            use close(Hide("item_profile"), name = "隐 藏")#隐藏原为hide，要是报错就改回去
