...
label init_perks():
    python:
        ...
        perk_description = {
                             "女仆之路" : "让我来侍奉您，主人。",
                             "主仆羁绊" : "主人和仆人之间的关系是神圣的。",
                             "不辞辛劳" : "只要你全身心的投入，就不会感觉疲惫。",
                             "将功补过" : "非常抱歉，让我将功补过吧。",
                             "求生意志" : "在鬼门关里走过一遭后, 为了生存她愿意付出一切。",
                             "完美主义" : "世上无难事，只怕有心人。这才不是强迫症。",

                             "兔装女郎" : "谁能喂可怜的小兔子一根大胡萝卜?'",
                             "派对焦点" : "别急着走嘛，派对才刚刚开始...后面还有更刺激的。",
                             ...
                             "阿谀奉承" : "你看起来就像个贵族公子...",
                             "宾至如归" : "来吧，让我们脱掉这些束缚，一起快活一下吧?",
                             "品味高雅" : "别忘了喂饱我的姐妹，试试左右开弓，双管齐下...",
                             "五星好评" : "一分钱一分货，可别吝啬你的消费哦。",
                             "飘飘欲仙" : "我会让你体验升天的快感...",
                             "皇家体验" : "今晚，您就是我的国王陛下，让奴家好好伺候您...",

                             "见钱眼开" : "只要出得起钱，我就让你为所欲为。",
                             "引人注目" : "所有人，都看着我，我要去了~啊~",
                             "欲海难填" : "就这点本事? 我还能再大战三百回合...",
                             "随叫随到" : "她还能再接一单，刚才那个很快就缴械投降了。",
                             "淫娃荡妇" : "嗯...你很持久嘛，试试这个姿势呢。",
                             "乐在其中" : "对她来说不过是玩玩而已, 你不会动了真感情吧。",

                             "小狐狸精" : "别摸我的耳朵和尾巴，那里，嗯，不行！",
                             "触类旁通" : "听说在黑市有一种神奇的薄荷叶，它可以让人瞬间发情...",
                             "拾金有昧" : "他把一些珠宝落下了，他本来还想把这些塞进那里呢。",
                             "不传之秘" : "这是她的独门绝技，人们都叫她榨汁姬，她可以用尾巴缠住你的肉棒。",
                             "幸运女神" : "她受幸运女神的庇佑，就算在危险期内射也不会怀孕...也许是生殖隔离？",
                             "招财进宝" : "她就是财富的象征!镀金的小穴滋味如何呢？",

                             "搔首弄姿" : "想看看我不为人知的一面吗?",
                             "思想开放" : "要勇于尝试新鲜事物，不试试怎么知道呢？",
                             "情迷意乱" : "你可以教教人家嘛?",
                             "如狼似虎" : "啊!大肉棒！欧金金！快给我！",
                             "巧舌如簧" : "今天给你特殊服务哦...",
                             "一心二用" : "吃完了甜点是不是该上主食了？",
                             ...
                             "助人为乐" : "有困难就来找我吧，我们都是好姐妹。",
                             "同甘共苦" : "今日你我义结金兰，有福同享有难同当。",
                             "以身作则" : "来，像我这样做，把手放到这里，嗯~没错",
                             "医者仁心" : "她把友情看的比生命还重要，为了朋友她什么都会做的。",
                             "贞洁烈女" : "'除了处女，我的一切都是您的... 您还想要我的心? 那就得看你的技术了...",
