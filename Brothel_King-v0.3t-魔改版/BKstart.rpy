    ...
    # CREATE CONTRACT TEMPLATES
        ...
        contract_templates = [
                    Contract(type="cruise", district="The Docks", archetypes = ["The Player", "The Fox"],
                            names=["海天盛筵", "近海航行", "退休仪式", "豪华邮轮游"],
                            organizers=["  水手工会", "  泽恩海军", "  游艇俱乐部", "  北地商队"],
                            venues=["私人快艇", "豪华游艇", "海上观景台", "巨型邮轮"],
                    ...
                    Contract(type="party", district="The Cathedra", archetypes = ["The Maid", "The Slut"],
                            names=["刺激派对", "教堂之夜", "无遮大会", "日不落", "赌神大赛"],
                            organizers=["邻邦大使", "本地勋贵", "公会高层", "资深法师", "国王的私人顾问"],
                            venues=["废弃的教堂", "歌舞伎町", "奢华的宫殿", "黑天鹅酒店", "地下赌场"],
                    ...
                    Contract(type="ceremony", district="The Cathedra", archetypes = ["The Model", "The Bride"],
                            names=["赐福庆典", "建教纪念日", "圣人诞辰", "四海朝拜", "祈祷日"],
                            organizers=["太阳神教会", "圣狄欧修女会", "启迪会", "莎莉娅的追随者", "古神信徒", "大祭司", "女祭司"],
                            venues=["修道院", "历史悠久的教堂", "隐世的庙宇", "祭祀神社", "金碧辉煌的大教堂", "贫穷的孤儿院"],
                            character=nun,
                            MC_event_pic="events/monster assault.webp",
                            ),
                    Contract(type="festival", district="The Slums", archetypes = ["The Player", "The Fox"],
                            names=["圆月之夜", "乡村庆典", "季节庆典", "乡村集会", "农贸展览", "传统节日"],
                            organizers=[ "农业协会", "乡土俱乐部", "园艺工会", "村委会", "乡村乐队", "牧民家族"],
                            venues=["蔬菜大棚", "中央广场", "农贸市场", "城镇入口", "主干道旁"],
                    ...
                    Contract(type="date", district="The Magic Gardens", archetypes = ["The Bride", "The Model"],
                            names=["佳人有约", "孤独的绅士", "临时女仆", "私人女仆"],
                            organizers=["哈里发亲王", "大祭司罗南", "纳博克领主", "大法师瑞森", "库迪议员", "粉红男爵", "努科姆公爵", "公会会长"],
                            character=young_maid,
                            venues=["豪华公寓", "乡间别墅", "祖宅", "贵族行宫", "私人寺庙", "度假村"],
                            MC_event_pic="NPC/encounters/thief4.webp",
                            ),
                    Contract(type="meeting", district="The Warehouse", archetypes = ["The Courtesan", "The Maid"],
                            names=["战略会议", "军事演习", "政治协商", "议员会议"],
                            organizers=["城邦议会", "骑士团", "政府部门", "泽恩海军", "血岛联盟"],
                            venues=["圣战战略会议", "军事合作", "扩大市场", "新规制定", "限制条约", "降低关税", "增加税收"], # Different use for venue for this particular contract
                            character=diplomat,
                    ...
                    Contract(type="magic", district="The Magic Gardens", archetypes = ["The Escort", "The Courtesan"],
                            names=["万智牌大赛", "年度例会", "魔工学博览会", "法师公会团建", "魔法学院会议", "女巫限定"],
                            organizers=["传奇法师温蒂索斯", "女巫姐妹互助会", "死灵法师社团", "卡尔基长老会", "黑魔法师"],
                            venues=["闹鬼的古宅", "黑森林庄园", "法师尖塔", "地下怪物巢穴", "魔界传送门", "大图书馆"],
                            character=sorceress,
                            MC_event_pic="NPC/encounters/witches (1).webp",
                            ),
                    Contract(type="orgy", district="The King's Hold", archetypes = ["The Slut", "The Escort"],
                            names=["狂欢之夜", "无遮大会", "联谊会", "光棍节", "“高级”趣味"],
                            organizers=["猫族少女", "怡红院老板", "大祭司罗南", "修女合唱团", "残障权益组织", "红灯区业主", "不愿透露身份的皇室成员", "暴发户", "贵族千金"],
                            venues=["林中空地", "野外露营地", "昏暗的地牢", "荒废的宫殿", "不正经的酒楼", "秘密基地", "无人问津的庙宇"],
